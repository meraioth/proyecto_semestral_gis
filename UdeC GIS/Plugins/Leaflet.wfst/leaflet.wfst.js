...
L.WFST = L.GeoJSON.extend({
    ...
    initialize: function(geojson,options){
        ...
        if(typeof initOptions.geoJsonUrl == 'undefined'){ 
            initOptions.geoJsonUrl = options.url + '?service=WFS&version=' + options.version + '&request=GetFeature&typeName=' + options.featureNS + ':' + options.featureType + '&outputFormat=application/json';
        }
